...
```shell
-javaagent:F:\Workspace\MyAgent\target\myAgent-1.0.jar=yoystar
-javaagent:F:\Workspace\MyAgent\target\myAgent-1.0.jar=jjys
```
...
public class FruitTransformer implements ClassFileTransformer {
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
        ...
        if (!className.equals("com/cn/yoystar/test/Fruit"))
            return classfileBuffer;

        String fileName="F:\\Workspace\\agent-test\\target\\classes\\com\\cn\\yoystar\\test\\Fruit2.class";
...
static byte[] calculate() throws Exception {
    ...
    CtClass ctClass = pool.get("com.cn.yoystar.test.Fruit");
